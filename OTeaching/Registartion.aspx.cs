...
public partial class Registartion : System.Web.UI.Page
{
    ...
    public SqlConnection con = new SqlConnection(@"Data Source=DESKTOP-ETPN17L\SQLEXPRESS;Initial Catalog=OTeaching;Integrated Security=True; TrustServerCertificate=True");

    //Data Source=LAPTOP-83GOR2JH;Initial Catalog=OTeaching;Integrated Security=True
